...
(function () {
  ...
  function buildMessageBody(b) {
    ...
    return [
      ...
      '',
      'Хочу предложить ' + (b.company ? '«' + b.company + '»' : 'вашей компании') + ' ознакомиться с готовым девелоперским активом: 200 кадастровых участков (42,7 га) на берегу реки Воронеж, с оформленной концепцией коттеджного посёлка. Продаётся целиком одному инвестору.',
      '',
